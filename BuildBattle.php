...
class Main extends PluginBase implements Listener
{
    ...
    public function PlayerItemHeldEvent(PlayerItemHeldEvent $event){
        ...
        if($i->getId() == 35 && $i->getDamage() == 5){
            $p->sendMessage(TextFormat::GREEN."Vous avez voté!");
            $p->sendTip(TextFormat::GREEN."Vous avez voté!");
            ...
            $p->sendMessage(TextFormat::YELLOW."Vous avez voté!");
            $p->sendTip(TextFormat::YELLOW."Vous avez voté!");
            $event->setCancelled(true);
            if($this->bb[12] == "1"){
            ...
            $p->sendMessage(TextFormat::RED."Vous avez voté!");
            $p->sendTip(TextFormat::RED."Vous avez voté!");
            $event->setCancelled(true);
            if($this->bb[12] == "1"){
